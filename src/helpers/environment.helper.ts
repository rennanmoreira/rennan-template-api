...
export const FF_UPDATE_PRODUCT_ON_IMPORT = isBoolean(process?.env?.FF_UPDATE_PRODUCT_ON_IMPORT)
...
export const FIREBASE_AUTH_BASE_API = process?.env?.FIREBASE_AUTH_API || ''
